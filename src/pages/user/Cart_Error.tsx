...
import error from '../../assets/img_notification/img_err.png';
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-6 relative max-w-sm w-full">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="">
              <img src={error} alt="Lỗi thanh toán" />
            </div>
            <h2 className="text-xl font-bold mb-2">Hoàn tất đơn hàng</h2>
            <p className="text-gray-600 mb-4">
              Bạn vui lòng kiểm tra lại thông tin <br />
              Hãy liên hệ với chúng tôi hỗ trợ bạn
            </p>
